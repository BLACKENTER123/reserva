...
<head>
		...
		<!-- Bootstrap Min CSS --> 
		<link rel="stylesheet" href="<?php echo RUTA_PRINCIPAL . 'assets/principal'; ?>
...
/css/responsive.css">
		...
		<!-- Favicon -->
		<link rel="icon" type="image/png" href="<?php echo RUTA_PRINCIPAL . 'assets'; ?>
/img/logo_click.png">
...
">
								<img src="<?php echo RUTA_PRINCIPAL . 'assets'; ?>
/img/logo_click.png" width="100" alt="Logo">
							</a>
							<div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
								<ul class="navbar-nav m-auto">
									<li class="nav-item">
										<a href="<?php echo RUTA_PRINCIPAL . 'cancha'?>" class="nav-link">
											Canchas
